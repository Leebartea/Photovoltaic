...
const DEFAULTS = {
    ...
    PROPOSAL_PRICING: {
        ...
        regionDefaults: {
            ...
            oceania: { currencyLabel: 'USD', regionalMultiplier: 1.22, laborPct: 22, softCostPct: 10, marginPct: 14, taxPct: 0, supplierPricePack: 'oceania_remote_install', financeMode: 'grid_tariff_offset', energyRatePerKWh: 0.26, exportCreditPerKWh: 0.06, energyRatePerKWhUSD: 0.26, exportCreditPerKWhUSD: 0.06, annualEscalationPct: 3, annualMaintenancePct: 1.3 },
            global:  { currencyLabel: 'USD', regionalMultiplier: 1.00, laborPct: 18, softCostPct: 8, marginPct: 12, taxPct: 0, supplierPricePack: 'global_reference', financeMode: 'blended_site_energy', energyRatePerKWh: 0.18, exportCreditPerKWh: 0.03, energyRatePerKWhUSD: 0.18, exportCreditPerKWhUSD: 0.03, annualEscalationPct: 4, annualMaintenancePct: 1.5 }
        },
        pricePacks: {
            global_reference: {
